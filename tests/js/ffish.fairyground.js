...
`;
    ...
    var wasmImports = { h: ___cxa_throw, l: ___syscall_fcntl64, F: ___syscall_fstat64, w: ___syscall_ioctl, E: ___syscall_newfstatat, n: ___syscall_openat, G: __abort_js, q: __embind_register_bigint, s: __embind_register_bool, r: __embind_register_class, g: __embind_register_class_constructor, a: __embind_register_class_function, H: __embind_register_emval, k: __embind_register_enum, c: __embind_register_enum_value, p: __embind_register_float, d: __embind_register_function, e: __embind_register_integer, b: __embind_register_memory_view, I: __embind_register_std_string, j: __embind_register_std_wstring, t: __embind_register_void, A: __mmap_js, B: __munmap_js, u: __tzset_js, x: _clock_time_get, o: _emscripten_get_now, y: _emscripten_resize_heap, C: _environ_get, D: _environ_sizes_get, f: _exit, i: _fd_close, v: _fd_read, z: _fd_seek, m: _fd_write };
    function run() {
      if (runDependencies > 0) {
