...
var ModuleFactory = function(Module) {
  ...
  var _scriptName = (_b = (_a = globalThis.document) == null ? void 0 : _a.currentScript) == null ? void 0 : _b.src;
  ...
  if (ENVIRONMENT_IS_NODE) {
    ...
    readAsync = (filename, binary = true) => __async(null, null, function* () {
      filename = isFileURI(filename) ? new URL(filename) : filename;
  ...
  var FS_stdin_getChar = () => {
    ...
    if (!FS_stdin_getChar_buffer.length) {
      ...
      } else if ((_a2 = globalThis.window) == null ? void 0 : _a2.prompt) {
  ...
  var preloadPlugins = [];
  var FS_handledByPreloadPlugin = (byteArray, fullname) => __async(null, null, function* () {
  ...
  var FS_preloadFile = (parent, name, url, canRead, canWrite, dontCreateFile, canOwn, preFinish) => __async(null, null, function* () {
  ...
  var FS = { root: null, mounts: [], devices: {}, streams: [], nextInode: 1, nameTable: null, currentPath: "/", initialized: false, ignorePermissions: true, filesystems: null, syncFSRequests: 0, ErrnoError: class {
    ...
    (_b2 = (_a2 = FS.createDevice).major) != null ? _b2 : _a2.major = 64;
  ...
  var __embind_register_class = (rawType, rawPointerType, rawConstPointerType, baseClassRawType, getActualTypeSignature, getActualType, upcastSignature, upcast, downcastSignature, downcast, name, destructorSignature, rawDestructor) => {
    ...
    whenDependentTypesAreResolved([rawType, rawPointerType, rawConstPointerType], baseClassRawType ? [baseClassRawType] : [], (base) => {
      ...
      if (registeredClass.baseClass) {
        (_b2 = (_a2 = registeredClass.baseClass).__derivedClasses) != null ? _b2 : _a2.__derivedClasses = [];
...
`;
  ...
  var getEnvStrings = () => {
    ...
    if (!getEnvStrings.strings) {
      var lang = ((_b2 = (_a2 = globalThis.navigator) == null ? void 0 : _a2.language) != null ? _b2 : "C").replace("-", "_") + ".UTF-8";
  ...
  var ___getTypeName, _malloc, _free, _emscripten_builtin_memalign, memory, __indirect_function_table, wasmMemory, wasmTable;
  function assignWasmExports(wasmExports2) {
    ___getTypeName = wasmExports2["L"];
    _malloc = wasmExports2["N"];
    _free = wasmExports2["O"];
    _emscripten_builtin_memalign = wasmExports2["P"];
    memory = wasmMemory = wasmExports2["J"];
    __indirect_function_table = wasmTable = wasmExports2["M"];
  }
  var wasmImports = { h: ___cxa_throw, l: ___syscall_fcntl64, F: ___syscall_fstat64, w: ___syscall_ioctl, E: ___syscall_newfstatat, n: ___syscall_openat, G: __abort_js, r: __embind_register_bigint, s: __embind_register_bool, p: __embind_register_class, g: __embind_register_class_constructor, a: __embind_register_class_function, H: __embind_register_emval, k: __embind_register_enum, d: __embind_register_enum_value, q: __embind_register_float, e: __embind_register_function, f: __embind_register_integer, c: __embind_register_memory_view, I: __embind_register_std_string, j: __embind_register_std_wstring, t: __embind_register_void, A: __mmap_js, B: __munmap_js, u: __tzset_js, x: _clock_time_get, o: _emscripten_get_now, y: _emscripten_resize_heap, C: _environ_get, D: _environ_sizes_get, b: _exit, i: _fd_close, v: _fd_read, z: _fd_seek, m: _fd_write };
  function run() {
    if (runDependencies > 0) {
...
var stdin_default = ModuleFactory;
export {
